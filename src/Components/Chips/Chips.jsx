...
const Chips = () => {
       ...
       const getChipsView = () => (
        ...
        <label className={styles.Button.text} onClick={()=> filterDispatch({type : "CATEGORY" , payload : "All"})}>
            <input type="radio" name="myRadio" className={styles.Button.radioButton} />Explore  
        </label>
         <label className={styles.Button.text} onClick={() => filterDispatch({ type: "CATEGORY", payload: "Spirituality" })}>
            <input type="radio" name="myRadio" className={styles.Button.radioButton}/>Ranveer Allahbadia
        </label>
        <label className={styles.Button.text}  onClick={() => filterDispatch({ type: "CATEGORY", payload: "Coding" })}>
            <input type="radio" name="myRadio" className={styles.Button.radioButton} />Coding
        </label>
        <label className={styles.Button.text} onClick={() => filterDispatch({ type: "CATEGORY", payload: "Talks" })}>
            <input type="radio" name="myRadio" className={styles.Button.radioButton}/>Talks
        </label>
        <label className={styles.Button.text} onClick={() => filterDispatch({ type: "CATEGORY", payload: "Finanace" })}>
            <input type="radio" name="myRadio" className={styles.Button.radioButton}/>Finanace
        </label>
         <label className={styles.Button.text} onClick={() => filterDispatch({ type: "CATEGORY", payload: "Mystery" })}>
            <input type="radio" name="myRadio" className={styles.Button.radioButton}/>Dhruv Rathee
        </label>
        <label className={styles.Button.text} onClick={() => filterDispatch({ type: "CATEGORY", payload: "StockMarket" })}>
            <input type="radio" name="myRadio" className={styles.Button.radioButton}/>Stock Market
        </label>
        <label className={styles.Button.text} onClick={() => filterDispatch({ type: "CATEGORY", payload: "Cyrpto" })}>
            <input type="radio" name="myRadio" className={styles.Button.radioButton}/>Cyrpto
        </label>
        <label className={styles.Button.text} onClick={() => filterDispatch({ type: "CATEGORY", payload: "Bollywood" })}>
